...
class CustomDataTable extends StatefulWidget {
  ...
  Function(int column) onSortColumn;
  // bool isSortup;
...
class _CustomDataTableState extends State<CustomDataTable> {
  ...
  Widget _buildCheckbox({
    ...
    Widget showedCheckbox = ValueListenableBuilder<bool>(
        valueListenable: checked,
        builder: (_, checked, __) {
  ...
  Widget build(BuildContext context) {
    ...
    if (displayCheckboxColumn) {
      ...
      for (final CustomDataRow row in widget.rows) {
        ...
        tableRows[rowIndex].children![0] = _buildCheckbox(
          ...
          onRowTap: () => print("custom row handler"),
    ...
    for (int columnIndex = 0;
      ...
      for (final CustomDataRow row in widget.rows) {
        ...
        tableRows[rowIndex].children![displayColumnIndex] = _buildDataCell(
          context: context,
          padding: padding,
          label: widget.customColumnsIndex[displayColumnIndex - (widget.showCheckboxColumn ? 1:0)] ==  widget.sortColumnIndex ?  Row(children: [cell.child,SizedBox(width: 16.0,)],) : cell.child,
          numeric: column.numeric,
          ...
          onSelectChanged: () => print("select cell"),
          overlayColor: row.color ?? effectiveDataRowColor,
        );
        rowIndex += 1;
      }
    ...
    // print("====================${widget.sortColumnIndexList}");
            ...
            Row(
              children: [
                if (widget.showCheckboxColumn)
                  InkWell(
                    child: tableRows[0].children![0],
                    onHover: (isHover) =>
                        widget.showCheckAllbox.value = isHover,
                    onTap: () {},
                ...
                CustomAdjustHeaderIndex(
                  columns: widget.showCheckboxColumn
                      ? tableRows[0].children!.sublist(1)
                      : tableRows[0].children!,
                  ...
                  (index) => ValueListenableBuilder(
                      ...
                      builder: (_, selected, __) {
                        ...
                        tableRows[index + 1] = TableRow(
                          ...
                          children: tableRows[index + 1].children,
                        );

                        // allChecked.value = true; // check all checked
                        // allChecked.value = widget.rows.every((row) => row.selected.value);
                        // allChecked.value = false;

                        // // _handleSelectAll(true, allChecked);
